...
export default defineConfig(({ mode }) => {
  ...
  return { base: './', define: { __APP_BUILD__: JSON.stringify(`0.2.0+${revision}`), __GATEWAY_ORIGIN__: JSON.stringify(gateway.origin), __GATEWAY_ALLOW_LOCAL__: JSON.stringify(gateway.allowLocal) },
